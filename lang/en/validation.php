...
return [
    ...
    | comme les règles de taille. Vous pouvez les modifier pour personnaliser
    | vos messages selon vos besoins.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour remplacer le placeholder de
    | l’attribut par un nom plus compréhensible, par exemple "Adresse e-mail"
    | au lieu de "email".
    |
    */
